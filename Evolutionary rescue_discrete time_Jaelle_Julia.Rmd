...
# adding the population sizes, decay rates, selection coefficients and mutation rates
...
#With this function we simulate over generations, we put initial population sizes of the four mutations, with the parameter max_gen we determine that our simulation maximally runs until the 1000th generation
...
In this piece of code, we calculate the rescue probability of each mutant separately and visualize this using different plots.
