...
*Question:*	How do 2 deleterious mutations of different strength , which can mutate to beneficial ones, influence the probabilty of rescue and how does their frequency in the population change?
  ...
  # loop over selection coefficients
    ...
    # reset counter
      ...
      # enter the data into the table
        data_table <- rbind(data_table,c(mval_wm,mval_sm,sval_wm,sval_sm,N_end_wd, N_end_wb, N_end_sd, N_end_sb,freq_wd, freq_wb, freq_sd,freq_sb)) # note that we add the varying       parameters (decay rate and selection coefficient) to the table too
