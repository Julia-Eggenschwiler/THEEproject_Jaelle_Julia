...
print(simulate_one_gen(N_wd=50, N_wb=0, N_sd=50, N_sb=0, decay_rate_wm=0.025, decay_rate_sm=0.05, s_wm=0.1, s_sm=0.2, m_rate_wm=0.05, m_rate_sm=0.07))
```
...
output <- simulate_pop(init_wd=50, init_wb=0,  init_sd=50, init_sb=0, decay_rate_wm=0.06, decay_rate_sm=0.12, s_wm=0.1, s_sm=0.2, m_rate_wm=0.05, m_rate_sm=0.07,max_gen)
